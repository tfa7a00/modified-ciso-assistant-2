	...
	function applyFullState(state: Record<string, unknown>) {
		...
		if (state.cartoRows && Array.isArray(state.cartoRows)) {
			const arr = (state.cartoRows as CartoRow[]).map((r, i) => {
				...
				// All rows: show original default text for any cell that was never saved (empty/undefined)
				if (firstRowDefaultContent) {
				...
				<td class="px-2 py-2 border border-black bg-white align-top">
					<textarea class="w-full text-xs p-1 resize-none" rows="6" bind:value={row.descriptionScenario} on:blur={() => saveCustomMethodState()}></textarea>
						...
						<td class="px-2 py-2 text-center border border-black bg-gray-100 align-middle">
							<input type="number" class="w-full min-w-12 text-xs p-1 text-center bg-transparent" min="1" max="4" bind:value={row.impactD} />
						</td>
						<td class="px-2 py-2 text-center border border-black bg-gray-100 align-middle">
							<input type="number" class="w-full min-w-12 text-xs p-1 text-center bg-transparent" min="1" max="4" bind:value={row.impactI} />
						</td>
						<td class="px-2 py-2 text-center border border-black bg-gray-100 align-middle">
							<input type="number" class="w-full min-w-12 text-xs p-1 text-center bg-transparent" min="1" max="4" bind:value={row.impactC} />
						</td>
						...
						<td class="px-2 py-2 border border-black bg-white align-middle">
							<input type="number" class="w-full text-xs p-1 text-center" min="1" max="6" bind:value={row.impactFinancier} />
						</td>
						<td class="px-2 py-2 border border-black bg-white align-middle">
							<input type="number" class="w-full text-xs p-1 text-center" min="1" max="6" bind:value={row.impactPP} />
						</td>
						<td class="px-2 py-2 border border-black bg-white align-middle">
							<input type="number" class="w-full text-xs p-1 text-center" min="1" max="6" bind:value={row.impactReputation} />
						</td>
						<td class="px-2 py-2 border border-black bg-white align-middle">
							<input type="number" class="w-full text-xs p-1 text-center" min="1" max="6" bind:value={row.impactReglementaire} />
						</td>
						...
						<!-- Probabilité -->
						<td class="px-2 py-2 border border-black bg-white align-middle">
							<input type="number" class="w-full text-xs p-1 text-center" min="1" max="5" bind:value={row.probabilite} />
						</td>
						...
						<td class="px-2 py-2 border border-black bg-yellow-200 align-middle">
							<input type="number" class="w-full text-xs p-1 text-center bg-transparent" min="1" max="6" bind:value={row.graviteNet} />
						</td>
						
						<!-- Risque Net - Probabilité -->
						<td class="px-2 py-2 border border-black bg-yellow-200 align-middle">
							<input type="number" class="w-full text-xs p-1 text-center bg-transparent" min="1" max="5" bind:value={row.probabiliteNet} />
						</td>
						...
						<td class="px-2 py-2 border border-black bg-white align-middle">
							<input type="number" class="w-full text-xs p-1 text-center" min="1" max="6" bind:value={row.impactResiduel} />
						</td>
						
						<!-- Risque Résiduel - Vraisemblance -->
						<td class="px-2 py-2 border border-black bg-white align-middle">
							<input type="number" class="w-full text-xs p-1 text-center" min="1" max="5" bind:value={row.vraisemblanceResiduel} />
						</td>
